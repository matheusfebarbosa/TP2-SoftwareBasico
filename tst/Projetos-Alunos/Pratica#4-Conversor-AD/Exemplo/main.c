 ...
 *     O  exemplo  configura  o  conversor  analógico  digital para  realizar *
 * aquisições   do   termômetro   interno   periodicamente.    Inicialmente a *
 * temperatura ambiente  é  armazenada  e  periodicamente  comparada  com  os *
 * valores correntes. Se os valores forem iguais, o  LED  vermelho  (P1.0)  é *
 * ativado. Caso contrário, o LED verde (P1.6) é ativado.                     *
 ******************************************************************************
 *                        ATIVIDADE PRÁTICA PROPOSTA                          *
 *     Altere o exemplo, de forma que:                                        * 
 * - O LED vermelho (P1.0) ativado indique uma variação positiva de tempratura*
 * - O LED verde (P1.6) ativado indique uma variação negativa  de temperatura *
 *     A  temperatura  calibrada  é  lida  e  armazenada  quando  o sistema é *
 * energizado. A variável utilizada é a "tempCalibrated".                     *
 ******************************************************************************/
